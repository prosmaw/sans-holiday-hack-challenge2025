...
## Solution
Tom asked tto exploit the vulnerabilities in the weather monitoring system and find the unused authorization key.
...
The note file gave instruction on the steps that I can take to exploit the vulnerabilities.
...
This shows that I can used a CommonsCollections payloads.
...
Since I was stucked, I checked online and find a report at this link [https://www.youtube.com/watch?v=rm8aunk9dSg&t=1247s](https://www.youtube.com/watch?v=rm8aunk9dSg&t=1247s) for the objective.

From there, I foundout that I can run the weather helper with the first key and get the second key.
